                        ...
                        <div className="flex bg-slate-200 p-1 rounded-xl gap-1 dark:bg-slate-700">
                            {(['Hoje', 'Semana', 'Mês', 'Todos'] as const).map(p => (
                                <button
                                    ...
                                    className={`px-3 py-1 text-xs font-bold rounded-lg transition-all ${mechanicSummaryPeriod === p
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                {[-10, -1, 1, 10].map(val => (
                                    <button
                                        ...
                                        className={`h-20 rounded-3xl font-black text-2xl shadow-sm transition-all active:scale-90 ${val > 0 ? 'bg-emerald-600 text-white hover:bg-emerald-700' : 'bg-rose-100 text-rose-600 hover:bg-rose-200'
                                            }`}
                                    >
                                        {val > 0 ? `+${val}` : val}
                                    </button>
                        ...
                        <div className="relative">
                            ...
                            <div className="flex gap-2 items-center">
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-2xl border-2 flex items-center justify-center transition-all ${isCameraActive
                            ...
                            sales.filter((s: any) => s.type === 'Oficina' && s.status !== 'Entregue').map((os: any) => (
                                <div key={os.id} className="p-4 border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-slate-800/50 flex flex-col gap-2 transition-all hover:border-amber-300">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider ${os.status === 'Pronto' ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' :
